...
int Ros2AchBridge::state_loop()
{
  ...
  {
    buff_motor_pos.data.push_back(this->dac.darwin_state.motor_state[i].pos);
    buff_motor_vel.data.push_back(this->dac.darwin_state.motor_state[i].speed);
    buff_motor_tor.data.push_back(this->dac.darwin_state.motor_state[i].load);
    buff_motor_vol.data.push_back(this->dac.darwin_state.motor_state[i].voltage);
    buff_motor_tmp.data.push_back(this->dac.darwin_state.motor_state[i].temp);
  }

  buff_imu.linear.x  =         this->dac.darwin_state.imu.acc_x;
  buff_imu.linear.y  =         this->dac.darwin_state.imu.acc_y;
  buff_imu.linear.z  =         this->dac.darwin_state.imu.acc_z;
  buff_imu.angular.x =         this->dac.darwin_state.imu.gyro_x;
  buff_imu.angular.y =         this->dac.darwin_state.imu.gyro_y;
  buff_imu.angular.z =         this->dac.darwin_state.imu.gyro_z;

  int id = ENUM_FT_LEFT;
  buff_ft_left.linear.x  =     this->dac.darwin_state.ft[id].x;
  buff_ft_left.linear.y  =     this->dac.darwin_state.ft[id].y;
  buff_ft_left.linear.z  = (  (this->dac.darwin_state.ft[id].raised_x) | (this->dac.darwin_state.ft[id].raised_y)  );
  buff_ft_left.angular.x =     this->dac.darwin_state.ft[id].raised_x ;
  buff_ft_left.angular.y =     this->dac.darwin_state.ft[id].raised_y;

  id = ENUM_FT_RIGHT;
  buff_ft_right.linear.x  =    this->dac.darwin_state.ft[id].x;
  buff_ft_right.linear.y  =    this->dac.darwin_state.ft[id].y;
  buff_ft_right.linear.z  = ( (this->dac.darwin_state.ft[id].raised_x) | (this->dac.darwin_state.ft[id].raised_y) );
  buff_ft_right.angular.x =    this->dac.darwin_state.ft[id].raised_x ;
  buff_ft_right.angular.y =    this->dac.darwin_state.ft[id].raised_y;
