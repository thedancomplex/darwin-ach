...
class DarwinLofaroClock : public rclcpp::Node
{
  public:
    ...
    {
      publisher_clock_ = this->create_publisher<geometry_msgs::msg::String>("/darwin/clock", 10);
...
//      RCLCPP_INFO(this->get_logger(), "Publishing: '%s'", message.data.c_str());
      publisher_clock_->publish(message_imu);
    }
    rclcpp::TimerBase::SharedPtr timer_;
    rclcpp::Publisher<geometry_msgs::msg::String>::SharedPtr publisher_clock_;
    size_t count_;
};
